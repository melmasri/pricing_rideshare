...
\begin{figure}[h!tbp]
    \centering
    \includegraphics[width=0.9\linewidth]{img/commuter-breakage.png}
    \caption{Breakage in the commuter membership: mean profit per member (CAD, over a $30$-ride
    month) as the share of committed rides actually taken falls from $100\%$ to $60\%$. The
    premium is collected in full regardless, so unused rides accrue directly to the provider.}
