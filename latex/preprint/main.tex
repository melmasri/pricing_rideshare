...
\begin{figure}
    ...
    population models are distinguished by grey dots and black crosses in the left
    panel; the middle panel uses the same encoding without a duplicate legend.}
...
because the premium being kept is itself two to three times larger.
...
$3.7\%$ of the member's fares, and any shortfall in utilization moves it into
profit. We have not stress-tested it against a holder who deliberately abuses the
remaining channel, so we claim the absence of a behavioural channel by
construction, not a measured reduction in exposure. Per-ride pricing conditions
