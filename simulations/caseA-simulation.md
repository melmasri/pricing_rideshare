...
replication of figure 1 in the Predictive Inference For Travel Time on
...
![](caseA-simulation_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

when set time=speed, the simulation result always produce a similar
result as the one in the paper?
...
![](caseA-simulation_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
