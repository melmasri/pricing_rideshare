...
Many egdes are not invertible(no record of going backward). But few of
them are. Like 959–34707, we have record on both directions.
...
![](graph_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
